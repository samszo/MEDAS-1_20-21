...
--
-- Host: localhost:8889
-- Generation Time: May 03, 2021 at 08:10 AM
...
CREATE TABLE `Appartement` (
  ...
  `Classe_E` varchar(45) DEFAULT NULL,
  `Surface` int(11) DEFAULT NULL,
  `Nb_Pieces` int(11) DEFAULT NULL,
  `Nb_Chambres` varchar(45) DEFAULT NULL,
  `Immeuble_idImmeuble1` int(11) NOT NULL,
  `Immeuble_Quartier_idQuartier` int(11) NOT NULL
...
CREATE TABLE `Commune` (
  ...
  `Nombre_dhab` int(11) DEFAULT NULL,
  `Departement` int(11) DEFAULT NULL,
  `Maire` varchar(45) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `Commune` (`idCommune`, `Superficie`, `Nombre_dhab`, `Departement`, `Maire`) VALUES
(1, '1290900', 129000, 32, 'Jean le Maire'),
(2, '23432', 2321, 11, 'Robert Thomas'),
(3, '3212', 233, 43, 'Marie de la Quiche'),
(4, '434', 22, 9, 'Jeanne de la Marre');
...
CREATE TABLE `Immeuble` (
  ...
  `Surface_PC` decimal(10,0) DEFAULT NULL,
  `Date_Construction` date DEFAULT NULL,
  `Etat_PC` decimal(10,0) DEFAULT NULL,
  `Digicode` varchar(45) DEFAULT NULL,
  `Quartier_idQuartier` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `Personne_has_Appartement`
--

CREATE TABLE `Personne_has_Appartement` (
  `Personne_idPersonne` int(11) NOT NULL,
  `Appartement_idAppartement` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `Quartier` (`idQuartier`, `Nom`, `Superficie`, `Commune_idCommune`) VALUES
(1, 'Gambetta', '234', 1),
(2, 'Centre', '232', 2),
(3, 'Clocher', '22', 3),
(4, 'Centre', '11', 4);
...
ALTER TABLE `Appartement`
  ADD PRIMARY KEY (`idAppartement`,`Immeuble_idImmeuble1`,`Immeuble_Quartier_idQuartier`),
  ADD KEY `fk_Appartement_Immeuble2_idx` (`Immeuble_idImmeuble1`,`Immeuble_Quartier_idQuartier`);
...
ALTER TABLE `Immeuble`
  ADD PRIMARY KEY (`idImmeuble`,`Quartier_idQuartier`),
  ADD KEY `fk_Immeuble_Quartier1_idx` (`Quartier_idQuartier`);
...
--
-- Indexes for table `Personne_has_Appartement`
--
ALTER TABLE `Personne_has_Appartement`
  ADD PRIMARY KEY (`Personne_idPersonne`,`Appartement_idAppartement`),
  ADD KEY `fk_Personne_has_Appartement_Appartement1_idx` (`Appartement_idAppartement`),
  ADD KEY `fk_Personne_has_Appartement_Personne_idx` (`Personne_idPersonne`);

--
-- Indexes for table `Quartier`
--
ALTER TABLE `Quartier`
  ADD PRIMARY KEY (`idQuartier`,`Commune_idCommune`),
  ADD KEY `fk_Quartier_Commune1_idx` (`Commune_idCommune`);
...
--
ALTER TABLE `Appartement`
  MODIFY `idAppartement` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `Appartement`
  ADD CONSTRAINT `fk_Appartement_Immeuble2` FOREIGN KEY (`Immeuble_idImmeuble1`,`Immeuble_Quartier_idQuartier`) REFERENCES `Immeuble` (`idImmeuble`, `Quartier_idQuartier`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `Immeuble`
--
ALTER TABLE `Immeuble`
  ADD CONSTRAINT `fk_Immeuble_Quartier1` FOREIGN KEY (`Quartier_idQuartier`) REFERENCES `Quartier` (`idQuartier`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `Personne_has_Appartement`
--
ALTER TABLE `Personne_has_Appartement`
  ADD CONSTRAINT `fk_Personne_has_Appartement_Appartement1` FOREIGN KEY (`Appartement_idAppartement`) REFERENCES `Appartement` (`idAppartement`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Personne_has_Appartement_Personne` FOREIGN KEY (`Personne_idPersonne`) REFERENCES `Personne` (`idPersonne`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `Quartier`
--
ALTER TABLE `Quartier`
  ADD CONSTRAINT `fk_Quartier_Commune1` FOREIGN KEY (`Commune_idCommune`) REFERENCES `Commune` (`idCommune`) ON DELETE NO ACTION ON UPDATE NO ACTION;
--
-- Database: `omk_medas1`
--
CREATE DATABASE IF NOT EXISTS `omk_medas1` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `omk_medas1`;
